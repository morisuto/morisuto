...
- **インフォメティス株式会社**
  - Application Engineer — IoTソリューション事業部 / enenowa など（2022/07〜2024/07）
- **identify株式会社**
  - Full Cycle Engineer — 開発部 / DeLMO など（2024/08〜）
...
- **ビジネス戦略から逆算する開発方針**：3C/4P・データ分析でリソース最大化
- **現場感のある課題解決**：営業職の経験を活かし、運用フローまで踏み込む
- **計画して自走・完遂する力**：要件定義から運用まで一気通貫で牽引
